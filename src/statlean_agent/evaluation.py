...
DEFAULT_VDVW_THEOREM_INVENTORY = (
    {
        ...
        "current_lean_declarations": (
            ...
            "StatInference.stochasticProcessSampleAt",
            ...
            "StatInference.FiniteBracketEmpiricalMeasureSemantics.toGlivenkoCantelliClass",
            "StatInference.FiniteBracketSampleEmpiricalMeasureSemantics",
            "StatInference.FiniteBracketSampleEmpiricalMeasureSemantics.toEmpiricalMeasureSemantics",
        ...
        "benchmark_task_ids": (
            ...
            "finite_endpoint_process_strong_law_eventual_bound_seed",
            "finite_bracket_process_endpoints_eventual_bound_seed",
            ...
            "finite_bracket_sample_empirical_measure_assembly_seed",
            "finite_bracket_sample_empirical_measure_constructor_seed",
            "finite_bracket_sample_empirical_measure_gc_seed",
...
DEFAULT_VDVW_PRIMITIVE_EMPIRICAL_SEMANTICS = (
    {
        ...
        "status": "design_ready_sample_empirical_measure_bridge",
        "source_anchor_ids": (
            "vdvw-gc-definition",
        ...
        "target_lean_signatures": (
            ...
            "def stochasticProcessSamples (observations : ℕ -> SampleSpace -> Observation) (ω : SampleSpace) : ∀ sampleSize, SampleAt Observation sampleSize",
            "def bracketEndpointObservationProcess (observations : ℕ -> SampleSpace -> Observation) (endpoint : Bracket -> Observation -> ℝ) : Bracket -> ℕ -> SampleSpace -> ℝ",
            ...
            "structure FiniteBracketSampleEmpiricalMeasureSemantics (indexClass : Set Index) (populationRisk : Index -> ℝ) (empiricalRisk : ℕ -> Index -> ℝ)",
        ),
        "current_lean_handoffs": (
        ...
        "validation_hooks": (
            ...
            "proof-carrying sample/empirical-measure bridge must still be tied to concrete iid empirical measures before exact outer-GC theorem work",
        ...
        "promotion_gate": "Promote only after sample-average, measure-backed endpoint notation, and sample/empirical-measure bridge compile and preserve existing endpoint SLLN benchmarks.",
    },
    {
    ...
    },
    {
        ...
        "target_lean_signatures": (
            ...
            "structure FiniteBracketSampleEmpiricalMeasureSemantics (indexClass : Set Index) (populationRisk : Index -> ℝ) (empiricalRisk : ℕ -> Index -> ℝ)",
            "def FiniteBracketSampleEmpiricalMeasureSemantics.toEmpiricalMeasureSemantics : FiniteBracketEmpiricalMeasureSemantics indexClass populationRisk empiricalRisk",
            "def FiniteBracketSampleEmpiricalMeasureSemantics.toGlivenkoCantelliClass : GlivenkoCantelliClass indexClass populationRisk empiricalRisk",
        ),
        "current_lean_handoffs": (
            "StatInference.empiricalDeviationBoundOn_of_bracket_endpoint_bounds",
            "StatInference.finite_endpoint_strong_law_eventually_abs_le_real",
